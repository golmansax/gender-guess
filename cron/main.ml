...
let write_coeffs_to_file lin_reg_coeffs =
  let out_channel = open_out "generated-lin_reg_coeffs.txt" in
  Printf.fprintf out_channel "%s" (Two_var_lin_reg.to_string lin_reg_coeffs)
...
let () =
  ...
  write_coeffs_to_file lin_reg_coeffs
